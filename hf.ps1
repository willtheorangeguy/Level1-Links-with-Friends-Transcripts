...
foreach ($Year in $YearFolders) {
    ...
    $RepoId = "$Year-Level1-Links-With-Friends-Transcripts"
    $PrettyName = "$Year Level1 Links with Friends Transcripts"
...
# $PrettyName
Complete transcripts from the $Year episodes of the Level1 Links with Friends podcast.
