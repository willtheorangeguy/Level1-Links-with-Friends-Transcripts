<!-- Logo -->
<h1 align="center">
  Level1 Links with Friends Transcripts
</h1>

<!-- Copy -->
<h4 align="center">Transcripts and summaries generated from the Level1 Links with Friends podcast episodes through OpenAI Whisper, Llama 3.1, and LanguageTool.</h4>

<!-- Badges -->
<div align="center">
  <!-- Issues -->
  <img alt="GitHub Issues" src="https://img.shields.io/github/issues/willtheorangeguy/Level1-Links-with-Friends-Transcripts">
  <!-- Pull Requests -->
  <img alt="GitHub Pull Requests" src="https://img.shields.io/github/issues-pr/willtheorangeguy/Level1-Links-with-Friends-Transcripts">
  <!-- Discord -->
  <img alt="Discord Server ID" src="https://img.shields.io/discord/1382526731528962088">
  <!-- Language Count -->
  <img alt="GitHub Languages" src="https://img.shields.io/github/languages/count/willtheorangeguy/Level1-Links-with-Friends-Transcripts">
</div>
...
- Pull all Level1 Links with Friends episodes, and convert them to audio.
...
**To clone and run your own copy of the transcript generator**, you'll need [Git](https://git-scm.com/downloads), [Ollama](https://ollama.com/) and a bunch of Python libraries installed on your computer. If you would rather not use Git, you can just download the code from GitHub [above](https://github.com/willtheorangeguy/Level1-Links-with-Friends-Transcripts/archive/refs/heads/main.zip). From your command line:

```bash
# Clone this repository
$ git clone https://github.com/willtheorangeguy/Level1-Links-with-Friends-Transcripts.git

# Go into the repository
$ cd Level1-Links-with-Friends-Transcripts
...
If support is required, please open a **[GitHub Discussion](https://github.com/willtheorangeguy/Level1-Links-with-Friends-Transcripts/discussions/new)** or join our **[Discord](https://discord.gg/mgbda4fesN)**.

## Contributing

Please contribute using [GitHub Flow](https://guides.github.com/introduction/flow). Create a branch, add commits, and [open a pull request](https://github.com/willtheorangeguy/Level1-Links-with-Friends-Transcripts/compare).
...
<table>
  <tr>
    ...
    <th align="center"><img src="https://level1techs.us-east-1.linodeobjects.com/optimized/4X/0/9/f/09f0796398f4f90d5dfe8c4fa71c1ecf6a0d4354_2_550x550.jpeg" width="150" height="150" alt="Level1Techs"/></th>
  </tr>
  <tr>
    ...
    <td align="center">Level1Techs</td>
  </tr>
  <tr>
    ...
    <td align="center"><a href="https://level1techs.com/">Web</a></td>
  </tr>
</table>
